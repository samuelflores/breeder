#ifndef BreederUtils_H_
#define BreederUtils_H_
#include "Utils.h"
#include <string>
#include <iostream>
...
public:
	...
	std::string getInsertionCode() { std::string myInsertionCode; myInsertionCode[0] = (residueID.getInsertionCode()) ; return myInsertionCode;}
